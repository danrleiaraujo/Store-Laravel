...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Tela de edição do produto') }}</div>
                    ...
                    <form method="POST" action="{{ route('products.update', $product->id) }}" enctype ='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input id="photo" type="file" class="form-control @error('photo') is-invalid @enderror" value="{{ $product->photo }}" name="photo" required autocomplete="new-photo">
